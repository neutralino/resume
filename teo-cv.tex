...
\begin{list2}
\item Analysis Tools:  Significant experience with ROOT data analysis framework. %, ASAP ray-tracing software %removed Labview
Past experience in Excel, Maple, Mathematica, NumPy, pandas, R.
%  with SAS; extensive use of C and Fortran statistical libraries.
\item Programming Languages:  Proficient in C++.  Working knowledge of Java, Python.  Past experience in Perl, %VHDL, 
Unix shell scripts, HTML, CSS.
%\item GUI development: Basic familiarity with wxPython
...
\item Experience with large-scale data analysis ($>$100 TB), Monte Carlo simulations, %this is for industry jobs
and multivariate regression techniques. %with TMVA toolkit
%\item Experience in 
